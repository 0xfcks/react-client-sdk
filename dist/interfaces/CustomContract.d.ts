...
export declare type CustomContractArgWrapper<props, T extends ContractType> = props | (props & {
    contractType: T;
    ...
    } : T extends ContractType.THIRDWEB_SIGNATURE ? SignedPayload : undefined;
});
export declare type fetchCustomContractArgsFromPropsResponse = {
    contractType?: ContractType;
    contractArgs?: any;
};
export declare const fetchCustomContractArgsFromProps: (props: Record<string, any>) => fetchCustomContractArgsFromPropsResponse;
 ...
 *
 */
declare type ArgumentMapType = {
    [key: string]: string | null | number | boolean | Array<ArgumentMapType> | ArgumentMapType;
};
 ...
 */
export declare type ReadMethodCallType = {
    name: string;
 ...
 */
export declare type WriteMethodCallType = ReadMethodCallType & {
    payment: {
        currency: 'MATIC' | 'ETH' | 'USDC' | 'SOL' | 'AVAX' | 'USDC.e';
        value: string;
    };
    callOptions?: {
        gasOptions?: 'low' | 'medium' | 'high';
    };
};
export {};
